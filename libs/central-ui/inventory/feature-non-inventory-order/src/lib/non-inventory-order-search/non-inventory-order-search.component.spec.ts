...
import { NonInventoryOrderSearchComponent } from './non-inventory-order-search.component';

describe('NonInventoryOrderSearchComponent', () => {
    let component: NonInventoryOrderSearchComponent;
    let fixture: ComponentFixture<NonInventoryOrderSearchComponent>;
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            ...
            declarations: [NonInventoryOrderSearchComponent, MockRouterLinkDirective],
            providers: [
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(NonInventoryOrderSearchComponent);
    ...
    describe('searchPage', () => {
        ...
        it('should pass the entityType', () => {
            expect(searchPage.entityType).toEqual('NonInventoryOrder');
        });

        it('should pass the searchPageFacade', () => {
            expect(searchPage.searchPageFacade).toEqual(component.nonInventoryOrderFacade);
        });
