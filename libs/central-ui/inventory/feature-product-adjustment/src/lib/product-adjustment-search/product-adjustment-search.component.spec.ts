...
import { ProductAdjustmentSearchComponent } from './product-adjustment-search.component';

describe('ProductAdjustmentSearchComponent', () => {
    let component: ProductAdjustmentSearchComponent;
    let fixture: ComponentFixture<ProductAdjustmentSearchComponent>;
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            ...
            declarations: [ProductAdjustmentSearchComponent, MockRouterLinkDirective],
            providers: [
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(ProductAdjustmentSearchComponent);
    ...
    describe('searchPage', () => {
        ...
        it('should pass the entityType', () => {
            expect(searchPage.entityType).toEqual('ProductAdjustment');
        });

        it('should pass the searchPageFacade', () => {
            expect(searchPage.searchPageFacade).toEqual(component.productAdjustmentFacade);
        });
